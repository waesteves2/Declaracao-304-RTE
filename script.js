// Variáveis para rastrear o estado do preenchimento
      ...
      function gerarDeclaracao() {
        ...
        const cpfsComFreteCobrado = ['342.539.108-90', '381.444.968-17', '825.608.978-49', '286.970.888-28','324.813.688-00', '293.806.928-62', '406.817.068-13','312.843.978-82','409.983.568-59', '315.851.618-70','351.268.478-38', '289.210.458-05', '130.807.158-29', '358.779.298-44', '351.286.478-38', '430.588.528-79', '120.101.058-69', '374.588.528-79', '351.286.478-38', '051.700.338-42', '411.312.438-89', '410.129.968-40', '248.955.688-65', '432.339.048-35', '215.443.638-26', '260.464.398-76', '341.159.118-83', '413.798.418-28', '227.209.948-39', '318.853.828-63', '319.881.098-17', '135.936.138-32'];
  ...
  `;
      ...
      function cidadeElegivel(cidade, grupo) {
        const gruposDeCidades = {
          ...
          litoralSP: ['UBATUBA', 'CARAGUATATUBA', 'SÃO SEBASTIÃO', 'ILHABELA', 'CUBATÃO', 'BERTIOGA', 'GUARUJÁ', 'SANTOS', 'SÃO VICENTE', 'PRAIA GRANDE', 'MONGAGUÁ', 'ITANHAÉM', 'PERUÍBE', 'IGUAPE', 'ILHA COMPRIDA', 'CANANÉIA']    // Cidades do litoral de São Paulo
        };
