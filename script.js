  ...
  `;
      ...
      function cidadeElegivel(cidade, grupo) {
        const gruposDeCidades = {
          ...
          litoralSP: ['UBATUBA', 'CARAGUATATUBA', 'SÃO SEBASTIÃO', 'ILHABELA', 'BERTIOGA', 'GUARUJÁ', 'SANTOS', 'SÃO VICENTE', 'PRAIA GRANDE', 'MONGAGUÁ', 'ITANHAÉM', 'PERUÍBE', 'IGUAPE', 'ILHA COMPRIDA', 'CANANÉIA']    // Cidades do litoral de São Paulo
        };
